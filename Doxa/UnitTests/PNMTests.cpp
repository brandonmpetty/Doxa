...
namespace Doxa::UnitTests
{
	...
	public:
		...
		TEST_METHOD(PNMRead24BitBinaryTest)
		{
			...
			// Assert
			const Pixel8 expected[] = { 
				Grayscale::Qt(0xFF, 0x01, 0x01), Grayscale::Qt(0x01, 0xFF, 0x01), Grayscale::Qt(0x01, 0x01, 0xFF),
				Grayscale::Qt(0xFF, 0xFF, 0xFF), Grayscale::Qt(0x78, 0x78, 0x78), Grayscale::Qt(0x01, 0x01, 0x01)
			};
